...
typedef enum {
    ...
    /* 0x06 */ BGCHECK_FLOORPROPERTY_CLIMB_DOWN_ADJACENT_WALL,
...
typedef enum {
    ...
    /* 0x01 */ BGCHECK_FLOORSPECIALPROPERTY_1,
    /* 0x02 */ BGCHECK_FLOORSPECIALPROPERTY_HURT_FLOOR,
    /* 0x03 */ BGCHECK_FLOORSPECIALPROPERTY_FIRE_HURT_FLOOR,
    /* 0x04 */ BGCHECK_FLOORSPECIALPROPERTY_SHALLOW_SAND,
    /* 0x05 */ BGCHECK_FLOORSPECIALPROPERTY_SLIPPERY_ICE,
    /* 0x06 */ BGCHECK_FLOORSPECIALPROPERTY_NO_FALL_DAMAGE,
    /* 0x07 */ BGCHECK_FLOORSPECIALPROPERTY_QUICKSAND_NO_HORSE,
    /* 0x08 */ BGCHECK_FLOORSPECIALPROPERTY_JABU_WALL,
    /* 0x09 */ BGCHECK_FLOORSPECIALPROPERTY_VOID_ON_TOUCH,
    /* 0x0A */ BGCHECK_FLOORSPECIALPROPERTY_10,
    /* 0x0B */ BGCHECK_FLOORSPECIALPROPERTY_LOOK_UP,
    /* 0x0C */ BGCHECK_FLOORSPECIALPROPERTY_QUICKSAND_HORSE_CAN_CROSS,
    /* 0x0D */ BGCHECK_FLOORSPECIALPROPERTY_MAX
} FloorSpecialProperty;

typedef enum {
    /* 0x00 */ BGCHECK_SURFACEMATERIAL_DIRT_DEFAULT,
    /* 0x01 */ BGCHECK_SURFACEMATERIAL_SAND,
    /* 0x02 */ BGCHECK_SURFACEMATERIAL_STONE,
    /* 0x03 */ BGCHECK_SURFACEMATERIAL_DIRT,
    /* 0x04 */ BGCHECK_SURFACEMATERIAL_SHALLOW_WATER,
    /* 0x05 */ BGCHECK_SURFACEMATERIAL_DEEP_WATER,
    /* 0x06 */ BGCHECK_SURFACEMATERIAL_TALL_GRASS,
    /* 0x07 */ BGCHECK_SURFACEMATERIAL_MAGMA,
    /* 0x08 */ BGCHECK_SURFACEMATERIAL_GRASS,
    /* 0x09 */ BGCHECK_SURFACEMATERIAL_WOOD_PLANK,
    /* 0x0A */ BGCHECK_SURFACEMATERIAL_WOOD,
    /* 0x0B */ BGCHECK_SURFACEMATERIAL_GRASS_2,
    /* 0x0C */ BGCHECK_SURFACEMATERIAL_ICE,
    /* 0x0D */ BGCHECK_SURFACEMATERIAL_CARPET,
    /* 0x0E */ BGCHECK_SURFACEMATERIAL_MAX
} SurfaceMaterial;
