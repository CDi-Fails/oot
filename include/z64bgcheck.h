...
typedef enum {
    /*  0 */ FLOOR_PROPERTY_NONE,
    /*  5 */ FLOOR_PROPERTY_VOID_PIT = 5,
    /*  6 */ FLOOR_PROPERTY_CLIMB_DOWN_ADJACENT_WALL,
    /*  7 */ FLOOR_PROPERTY_STOP_ALL_MOMENTUM,
    /*  8 */ FLOOR_PROPERTY_STOP_XZ_MOMENTUM,
    /*  9 */ FLOOR_PROPERTY_NO_JUMPING,
    /* 11 */ FLOOR_PROPERTY_FALLING_DIVE = 11,
    /* 12 */ FLOOR_PROPERTY_VOID_PIT_LARGE
} FloorProperty;
