...
typedef enum {
    ...
    /*  4 */ PLAYER_MELEEATKTYPE_LEFT_SLASH_1H,
    /*  5 */ PLAYER_MELEEATKTYPE_LEFT_SLASH_2H,
    /*  6 */ PLAYER_MELEEATKTYPE_LEFT_COMBO_1H,
    /*  7 */ PLAYER_MELEEATKTYPE_LEFT_COMBO_2H,
    /*  8 */ PLAYER_MELEEATKTYPE_RIGHT_SLASH_1H,
    /*  9 */ PLAYER_MELEEATKTYPE_RIGHT_SLASH_2H,
    /* 10 */ PLAYER_MELEEATKTYPE_RIGHT_COMBO_1H,
    /* 11 */ PLAYER_MELEEATKTYPE_RIGHT_COMBO_2H,
...
typedef enum {
    /* 0x00 */ PLAYER_MODELGROUP_SHIELD, // unused (except with the `func_80091880` bug)
