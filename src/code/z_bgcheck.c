...
u16 sSurfaceMaterialToSfxOffset[14] = {
    ...
    SURFACE_SFX_OFFSET_JABU,          // SURFACE_SFX_OFFSET_JABU
    SURFACE_SFX_OFFSET_WATER_SHALLOW, // SURFACE_SFX_OFFSET_WATER_SHALLOW
    SURFACE_SFX_OFFSET_WATER_DEEP,    // SURFACE_SFX_OFFSET_WATER_DEEP
    SURFACE_SFX_OFFSET_TALL_GRASS,    // SURFACE_SFX_OFFSET_TALL_GRASS
    SURFACE_SFX_OFFSET_LAVA,          // SURFACE_SFX_OFFSET_LAVA
    SURFACE_SFX_OFFSET_GRASS,         // SURFACE_SFX_OFFSET_GRASS
    SURFACE_SFX_OFFSET_BRIDGE,        // SURFACE_SFX_OFFSET_BRIDGE
    SURFACE_SFX_OFFSET_WOOD,          // SURFACE_SFX_OFFSET_VINE
    SURFACE_SFX_OFFSET_DIRT,          // SURFACE_SFX_OFFSET_IRON_BOOTS
    SURFACE_SFX_OFFSET_ICE,           // SURFACE_SFX_OFFSET_UNUSED
    SURFACE_SFX_OFFSET_CARPET,        // SURFACE_SFX_OFFSET_ICE
};
...
u16 SurfaceType_GetSfxOffset(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId) {
    s32 floorSfxOffset = SurfaceType_GetMaterial(colCtx, poly, bgId);

    if ((floorSfxOffset < 0) || (floorSfxOffset >= ARRAY_COUNT(sSurfaceMaterialToSfxOffset))) {
        return SURFACE_SFX_OFFSET_DIRT;
    }
    return sSurfaceMaterialToSfxOffset[floorSfxOffset];
}
