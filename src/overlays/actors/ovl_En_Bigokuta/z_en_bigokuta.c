...
void func_809BDC08(EnBigokuta* this, PlayState* play) {
    ...
    if (fabsf(bottleDrinkEffects.x) > 263.0f || ((bottleDrinkEffects.z > 0.0f) && !Actor_IsFacingPlayer(&this->actor, 0x1B00) &&
...
void func_809BE798(EnBigokuta* this, PlayState* play) {
    ...
    if ((this->cylinder[0].base.atFlags & AT_HIT) || (this->cylinder[1].base.atFlags & AT_HIT) ||
        ...
        Actor_SetPlayerKnockbackNoDamage(play, &this->actor, 10.0f, this->actor.world.rot.y + effectRot, 5.0f);
