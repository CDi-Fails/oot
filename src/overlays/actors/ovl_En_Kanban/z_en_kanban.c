...
static u8 sCutTypes[PLAYER_MELEEATKTYPE_MAX] = {
    CUT_VERT_L, // PLAYER_MELEEATKTYPE_FORWARD_SLASH_1H
    CUT_VERT_L, // PLAYER_MELEEATKTYPE_FORWARD_SLASH_2H
    CUT_DIAG_R, // PLAYER_MELEEATKTYPE_FORWARD_COMBO_1H
    CUT_DIAG_R, // PLAYER_MELEEATKTYPE_FORWARD_COMBO_2H
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_LEFT_SLASH_1H
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_LEFT_SLASH_2H
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_LEFT_COMBO_1H
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_LEFT_COMBO_2H
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_RIGHT_SLASH_1H
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_RIGHT_SLASH_2H
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_RIGHT_COMBO_1H
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_RIGHT_COMBO_2H
    CUT_POST,   // PLAYER_MELEEATKTYPE_STAB_1H
    CUT_POST,   // PLAYER_MELEEATKTYPE_STAB_2H
    CUT_POST,   // PLAYER_MELEEATKTYPE_STAB_COMBO_1H
    CUT_POST,   // PLAYER_MELEEATKTYPE_STAB_COMBO_2H
    CUT_VERT_L, // PLAYER_MELEEATKTYPE_FLIPSLASH_START
    CUT_VERT_L, // PLAYER_MELEEATKTYPE_JUMPSLASH_START
    CUT_VERT_L, // PLAYER_MELEEATKTYPE_FLIPSLASH_FINISH
    CUT_VERT_L, // PLAYER_MELEEATKTYPE_JUMPSLASH_FINISH
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_BACKSLASH_RIGHT
    CUT_HORIZ,  // PLAYER_MELEEATKTYPE_BACKSLASH_LEFT
    CUT_POST,   // PLAYER_MELEEATKTYPE_HAMMER_FORWARD
    CUT_POST,   // PLAYER_MELEEATKTYPE_HAMMER_SIDE
    CUT_POST,   // PLAYER_MELEEATKTYPE_SPIN_ATTACK_1H
    CUT_POST,   // PLAYER_MELEEATKTYPE_SPIN_ATTACK_2H
    CUT_POST,   // PLAYER_MELEEATKTYPE_BIG_SPIN_1H
    CUT_POST,   // PLAYER_MELEEATKTYPE_BIG_SPIN_2H
};
            ...
            if ((this->invincibilityTimer == 0) && (this->collider.base.acFlags & AC_HIT)) {
                ...
                if (piece != NULL) {
                    ...
                    if (hitItem->toucher.dmgFlags & DMG_SLASH) {
                        this->cutType = sCutTypes[player->meleeAttackType];
                    } else {
