...
void EnWf_Wait(EnWf* this, PlayState* play) {
    ...
    if (!EnWf_DodgeRanged(play, this)) {
        ...
        if ((this->actor.xzDistToPlayer < 80.0f) && (player->isMeleeWeaponAttacking != 0) && (angle >= 0x1F40)) {
            this->actor.shape.rot.y = this->actor.world.rot.y = this->actor.yawTowardsPlayer;
            EnWf_SetupRunAroundPlayer(this);
        } else {
            this->actionTimer--;
...
void EnWf_RunAtPlayer(EnWf* this, PlayState* play) {
    ...
    if (!EnWf_DodgeRanged(play, this)) {
        ...
        if ((this->actor.xzDistToPlayer < (150.0f + baseRange)) && (player->isMeleeWeaponAttacking != 0) &&
