...
void EnBb_Down(EnBb* this, PlayState* play) {
    ...
    if (this->actor.bgCheckFlags & (BGCHECKFLAG_GROUND | BGCHECKFLAG_GROUND_TOUCH)) {
        if (this->actor.params == ENBB_RED) {
            ...
            if ((floorType == BGCHECK_FLOORSPECIALPROPERTY_HURT_FLOOR) ||
                (floorType == BGCHECK_FLOORSPECIALPROPERTY_FIRE_HURT_FLOOR) ||
                (floorType == BGCHECK_FLOORSPECIALPROPERTY_VOID_ON_TOUCH)) {
