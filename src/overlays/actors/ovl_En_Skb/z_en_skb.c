                    ...
                    if (this->breakFlags == 0) {
                        if ((this->actor.colChkInfo.damageEffect == 0xD) ||
                            ((this->actor.colChkInfo.damageEffect == 0xE) &&
                             ((player->meleeAttackType >= PLAYER_MELEEATKTYPE_LEFT_SLASH_1H &&
                               player->meleeAttackType <= PLAYER_MELEEATKTYPE_RIGHT_COMBO_2H) ||
                              (player->meleeAttackType == PLAYER_MELEEATKTYPE_BACKSLASH_RIGHT ||
                               player->meleeAttackType == PLAYER_MELEEATKTYPE_BACKSLASH_LEFT)))) {
