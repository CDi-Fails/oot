...
void func_80ABBB34_2(EnVase* this, GlobalContext* globalCtx);
void func_80ABBBA8_2(EnVase* this, GlobalContext* globalCtx);
...
void EnVase_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->objBankIndex < 0) {
        ...
        this->actionFunc = func_80ABBB34_2;
    }
}
...
void func_80ABBB34_2(EnVase* this, GlobalContext* globalCtx) {
    if (Object_IsLoaded(&globalCtx->objectCtx, this->objBankIndex)) {
        ...
        this->timer = 30;
        this->actionFunc = func_80ABBBA8_2;
...
void EnVase_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (!(player->stateFlags1 & 0x300000C0) || (this->actionFunc == func_80ABBB34_2)) {
